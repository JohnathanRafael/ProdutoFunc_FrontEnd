...
export class FormProdutoComponent {
  ...
  createForm() {
    this.formGroup = this.formBuilder.group({
      ...
      produtoEstoque: [null, [Validators.required]],
    });
  }
  ...
  private realizarInclusao() {
    if (this.formGroup.valid) {
      ...
      this.produtoControllerService.incluir({body: this.formGroup.value})
        .subscribe(retorno => {
  ...
  private prepararEdicao() {
    ...
    if (paramCodigo) {
      ...
      this.produtoControllerService.obterPorId({id: codigo}).subscribe(
        retorno => {
  ...
  private realizarEdicao() {
    this.produtoControllerService.alterar({id: this.codigo, body: this.formGroup.value})
      .subscribe(retorno => {
